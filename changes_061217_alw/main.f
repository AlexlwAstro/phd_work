...
C	TRAS is an array of conversion factors for G parameters
...
c Only instance of DIFFUS being call in this file!!
...
C*********************************************************************** 
  100 FORMAT(4I5) ! modstart line 1 format
  104 FORMAT(4I5,f8.4,2I3,I6,I3) 
  101 FORMAT(13I5) ! modstart line 2 format
...
C-FABIO     &DD(6,10),FF(8),HH(8),CV(9),RPQ(9),ES(20)
     &DD(6,50),FF(8),HH(8),CV(9),RPQ(9),ES(20)
      DIMENSION EE(13),DFIS(4),DFIX(4),IVME(4),IMINT(50),IMEST(50)
...
C ********************* STAMPA FISICA VARIA ****************************
     ...
     &FLNEU,GENCAR,FLCAR ! fusion energy quantities
