...
In this project, three broad-band filter systems were employed. These are the Advanced Camera System (ACS) and the Wide-Field Camera 3 (WFC3), both mounted on the Hubble Space Telescope, and the single filter set mounted on the Gaia space observatory.
...
Given the large number of filters studied in Section \ref{coef_models}
