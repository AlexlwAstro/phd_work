...
The treatment of extinction in observational surveys is usually via a global extinction value for each filter, such as the $A_{X}/A_{V}$ ratios given by \cite{1985ApJ...288..618R}. This approach has the significant issue of producing $A_{X}$
 ****independent of filter properties, such as the filter bandwidth,
