...
In observations, the extinction for a given source is initially unknown. For a stellar population, observers must make use of CMD features (absolute magnitudes) that vary as little as possible with variations in intrinsic parameters ****Independent of filter properties, such as the filter bandwidth,
