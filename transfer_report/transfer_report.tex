...
where $C_{\textnormal{thl}}$ is a free parameter, which is set in this work to a value of $C_{\textnormal{thl}} = 1000$****refs, $\nabla _{\mu} = d\ln\mu / d\ln P$, $\phi = \left( \partial \ln\rho / \partial \ln\mu \right)_{P,T}$, $\delta = -\left( \partial \ln\rho / \partial \ln T \right)_{P,\mu}$ \citep{1980A&A....91..175K} and $K$ is the thermal diffusivity \citep{2017RSOS....470192S}, defined as:
