...
c 1  continue  
      ...
      do 2 i=1, 15001
        read(1,*, end=21) wavef(ik, i),ff(ik,i)
...
c*********************************** 
c********** zero point flux STmag **************
c       fvega(i)=3.631e-8  ! erg s^-1 cm^-2 nm^-1 ! UNCERTAIN 
...
c      write(*,*) iz, 'correzione bolometrica=',bcV(ikj)
 ...
 2224 continue
      ...
      write(9,444) teff, zlogg, (bcV(ikj), ikj=1,7)
